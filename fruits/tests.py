...
class FruitTest(TestCase):
    ...
    def test_new_submit(self):
        response = self.client.post('/fruit/new/', data={
            'name': 'りんご',
            'price': 200
        }, follow=True)
        self.assertEqual(response.status_code, 200)
    ...
    def test_new_submit_with_no_login(self):
        ...
        response = client.post('/fruit/new/', data={
            'name': 'りんご',
            'price': 200
        }, follow=True)
        self.assertEqual(response.status_code, 200)
    ...
    def test_edit_submit(self):
        response = self.client.post('/fruit/1/edit/', data={
            'name': 'りんご',
            'price': 200
        }, follow=True)
        self.assertEqual(response.status_code, 200)
    ...
    def test_edit_submit_with_no_login(self):
        ...
        response = client.post('/fruit/1/edit/', data={
            'name': 'りんご',
            'price': 200
        }, follow=True)
        self.assertEqual(response.status_code, 200)
